...
if(AdminID==mydata["info"][i]["ID"]){
  ...
  outputhtml += "<td>" + "<button type='button' onclick='EditAdmin(" + mydata["info"][i]["ID"] + ")'>Edit Admin</button>";
    outputhtml += "<button type='button' onclick='deleteadmin(" + mydata["info"][i]["ID"] + ")'>Delete Admin</button>" + "</td>";
    outputhtml += "</tr>";
  }
}
  outputhtml += "</table>";
    ...
    function deleteadmin(AdminID) {
      //alert(ApptID);
        ...
        function EditAdmin(AdminID) {
          ...
          location.href="Edit-Admin.html?AdminID="+AdminID;
