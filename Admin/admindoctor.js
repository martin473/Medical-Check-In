...
function FormatData(mydata){
  ...
  for (var i = 0; i < arrayLength; i++) {
    ...
    outputhtml += "<td>" + "<button type='button' onclick='editdoctor(" + mydata["info"][i]["ID"] + ")'>Edit Doctor</button>";
    outputhtml += "<button type='button' onclick='deletedoctor(" + mydata["info"][i]["ID"] + ")'>Delete Doctor</button>" + "</td>";
    outputhtml += "</tr>";
  }
  outputhtml += "</table>";
    ...
    function deletedoctor(DoctorID) {
      //alert(ApptID);
        ...
        function editdoctor(DoctorID) {
          ...
          location.href="Edit-Doctor.html?DoctorID="+DoctorID;
