...
function FormatData(mydata){
  ...
  for (var i = 0; i < arrayLength; i++) {
    ...
    outputhtml += "<td>" + "<button type='button' onclick='EditDoctorapp(" + mydata["info"][i]["ApptID"] + ")'>Edit Appointment</button>";
    outputhtml += "<button type='button' onclick='DeleteDoctorapp(" + mydata["info"][i]["ApptID"] + ")'>Delete Appointment</button>" + "</td>";
    outputhtml += "</tr>";
  }
  outputhtml += "</table>";
  ...
  console.log(user_id);
    ...
    function DeleteDoctorapp(ApptID) {
      //alert(ApptID);
        ...
        function EditDoctorapp(AppointmentID) {
