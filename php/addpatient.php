...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	$sql = "INSERT INTO patient (`FirstName`, `MiddleName`, `LastName`, `DOB`, `Gender`, `Address`, `Email`, `Password`, `MedicationHistory`, `Medication`, `Conditions`) VALUES ('$FirstName', '$MiddleName', '$LastName', '$DOB', '$Gender', '$Address', '$Email', '$Password', '$MedicationHistory', '$Medication', '$Conditions');";
	$post_data_query = mysqli_query($conn, $sql);
	if($post_data_query){
		$json = array("status" => 1, "Success" => "Patient added.");
	}
	else{
