<?php
    ...
    $APPTID = isset($_POST['AppointmentID']) ? mysqli_real_escape_string($conn, $_POST['AppointmentID']) :  "";
	...
	$sql = $sql . "DoctorID, doctor.FirstName as 'dFirstName', doctor.MiddleName  as 'dMiddleName', doctor.LastName as 'dLastName',";
	$sql = $sql . "patient.Email, Status, patient.Gender, MedicationHistory, Conditions, Medication from appointment, patient, doctor ";
	$sql = $sql . "where appointment.PatientID = patient.id and appointment.DoctorID=doctor.id and appointment.id=$APPTID";
