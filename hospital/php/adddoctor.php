...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	$sql = "INSERT INTO doctor (FirstName, MiddleName, LastName, DOB, Gender, Address, Email, Password, Department, Specialization) VALUES ('$FirstName', '$MiddleName', '$LastName', '$DOB', '$Gender', '$Address', '$Email', '$Password', '$Department', '$Specialization');";
